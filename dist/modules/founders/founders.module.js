...
exports.FoundersModule = FoundersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: founder_schema_1.Founder.name, schema: founder_schema_1.FounderSchema }]),
            audit_module_1.AuditModule,
            startups_module_1.StartupsModule,
        ],
        controllers: [founders_controller_1.FoundersController],
        providers: [founders_service_1.FoundersService],
